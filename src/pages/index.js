      ...
      <div className="main">
        <div className="section">
          ...
          <p className="section-content">
            ...
            last eight years I've been proudly serving in the United States
            Navy, based in Yokosuka, Japan as a Radar Systems Technician, Weapon
            Systems Technician, Explosives Safety Manager, Instructional
            Designer, and Instructor.
            <br />
            <br />
            My love for development came when I was given the opportunity to
            look into the source code for one of the radar systems I worked on
            and give feedback on future features. From that moment, I stuck my
            head in the books and began studying the <strong>Ruby</strong>{' '}
            programming language, and enrolled in school to obtain a Bachelors
            of Science in Computer Science, all while being a top perfomer and
            innovator in my current role.
            <br />
            <br />
            ...
            the challenge of obtaining 100% uptime on systems critical to
            national defense while under the greatest pressures imaginable, all
            over the world! I hope to soon become part of a team of devolopers
            that share my love of the craft.
          </p>
        </div>
