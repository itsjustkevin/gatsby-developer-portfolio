  ...
  <Layout>
    ...
    <div className="section">
      ...
      <p className="section-content">
        ...
        books and began studying the <strong>Ruby</strong> programming language,
        and enrolled in school to obtain a Bachelors of Science in Computer
        Science, all while being a top perfomer and innovator at my job.
        <br />
        <br />
        The challenge of software engineering and design have both become my{' '}
        <strong>passion</strong> and <strong>obsession</strong>! I have met the
        challenge of obtaining 100% uptime on systems critical to national
        defense while under the greatest pressures imaginable, all over the
        world! I hope to soon become part of a team of devolopers that share my
        love of the craft.
      </p>
    </div>
    ...
    <div className="section">
      ...
      <p className="section-content">
        <span className="section-skill-label">Back-End:</span> Node, Java, PHP,
        Ruby
      </p>
      <p className="section-content">
